...
- Public repo `github.com/Em3ritus/simulacra`. Commit identity **must** be `Em3ritus <152051018+Em3ritus@users.noreply.github.com>` (the repo's local git config already is this — plain `git commit` is correct).
